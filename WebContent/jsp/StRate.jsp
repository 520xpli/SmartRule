...
<BODY onload="bodyOnload()">
	<h1 style="text-align: center; font-size: 18px">评级模型<font onclick="window.parent.location = window.parent.location.href + '&isShowCode=false'">维</font>护</h1>
	<form action="/StOrgSpreadMaintain.do">
			...
			<table align="left" width="100%" class="grid">
				...
				<tr>
					...
					<td><common:text empty="false" label="执行顺序" size="20"
							validator="digit(0,3)" name="stSingleRuleForm" onchange="reg()"
		...
		<div class="position">
			<div id="backupTable">
				<table style="text-align: center; margin-top: 10px;width:auto"
					...
					<tr>
						...
						<td style="white-space:nowrap"><input type="button" value="添加" onclick="addrow(this)"/>
							<input type="button" value="删除全部" onclick="deleteall(this)" style="display:inline"/></td>
					</tr>
					<tr class="row">
						<td><select name="strucVo.detailList.rowList.firstcal">
								<option value="">无</option>
					...
					<tr>
						...
						<td>结果:</td>
						<td>
							<input id="result" type="text"	name="strucVo.detailList.ruleresult"  style="width:150px" />
						</td>
					</tr>
				</table>
			</div>
						...
						<tr>
							<td>
									<select name="strucVo.detailList.rowList.firstcal">
											...
											<option value="*" <logic:equal value="*" name="row" property="firstcal">selected</logic:equal>>*</option>
											<option value="/" <logic:equal value="/" name="row" property="firstcal">selected</logic:equal>>/</option>
											<option value="min" <logic:equal value="min" name="row" property="firstcal">selected</logic:equal>>min</option>
											<option value="max" <logic:equal value="max" name="row" property="firstcal">selected</logic:equal>>max</option>
										</select></td>
								<td>
									<select name="strucVo.detailList.rowList.isleft">
										<option value=""> </option>
								...
								<td><select name="strucVo.detailList.rowList.secondcal">
										<option value="">无</option>
											...
											<option value="*" <logic:equal value="*" name="row" property="secondcal">selected</logic:equal>>*</option>
											<option value="/" <logic:equal value="/" name="row" property="secondcal">selected</logic:equal>>/</option>
											<option value="min" <logic:equal value="min" name="row" property="secondcal">selected</logic:equal>>min</option>
											<option value="max" <logic:equal value="max" name="row" property="secondcal">selected</logic:equal>>max</option>
								</select></td>
								...
								<td style="white-space:nowrap"><input type="button" value="添加" onclick="addrow(this)" />
									<logic:equal value="0" name="rowindexId">
										...
										<input id="result" type="button" value="删除" onclick="deleterow(this)"
									</logic:notEqual></td>
							</tr>
						</logic:iterate>
						<tr>
							...
							<td colspan="1" class="displayText">
								<input type="text"	name="strucVo.detailList.ruleresult" value="<bean:write name="detail" property="ruleresult"/>" style="width:150px" />
							</td>
						</tr>
					</table>
				</logic:iterate>
