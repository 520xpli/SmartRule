...
<BODY>
	<h1 style="text-align: center; font-size: 18px">额度计算<font onclick="window.parent.isShowCode=false">维</font>护</h1>
		...
		<div class="position" style="display:none">
			<div id="backupTable">
				<table style="text-align: center;margin-top:10px" class="ruletable grid">
					...
					<tr>
						<td>具体公式:</td>
						<td id="formulaDetail" colspan="6" style="word-wrap:break-word;word-break:break-all;white-space:normal;width:auto;"></td>
					</tr>
				</table>
			</div>
					...
					<table style="text-align: center;margin-top:10px" class="ruletable grid">
						...
						<logic:iterate id="row" name="detail" property="rowList"
							...
							<tr>
								...
								<td style="white-space:nowrap"><input type="button" value="添加" onclick="addrow(this)" />
									 <logic:notEqual value="0" name="rowindexId">
										<input type="button" value="删除" onclick="deleterow(this)"
									</logic:notEqual></td>
							</tr>
						</logic:iterate>
						<tr>
							<td style="width:10%">计算公式:</td>
							<td id="formulaDetail" style="word-wrap:break-word;word-break:break-all;white-space:normal;width:auto;" colspan="6"></td>
						</tr>
					</table>
				</logic:iterate>
		</div>
