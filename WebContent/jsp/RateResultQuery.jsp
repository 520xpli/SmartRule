...
<body>
	...
	<common:hidden name="stSystemForm" property="orgcodeR" styleId="orgcodeR"/>
	 <table width="100%">
	  	<TR>
				<TD class="pagehead" >申请打分卡结果查询（机构）</TD>
		</TR>
		<tr>
...
<script type="text/javascript">
	...
	function queryResultData(rateresultcode){
		...
		var url = '<%=request.getContextPath()%>'+'/st/StSystemMaintain.do?operAtt=rateScoreQuery&stRateresultDataVo.rateresultcode=' + rateresultcode+'&backUrl='+locurl;
