...
<BODY onload="myfunction()">
	...
	<common:hidden name="stOrgSpreadForm" property="stOrgSpreadVo.orgcode" styleId="orgcodeh"/>
	  <table width="100%">
	  	<TR>
				<TD class="pagehead" >推广参数维护（省联社）</TD>
		</TR>
		<tr>
					...
					<logic:iterate id="stOrgSpreadVo" name="stOrgSpreadForm"
						...
						<tr>
							...
							<td><bean:write name="stOrgSpreadVo" property="orgname"></bean:write></td>
								...
								<td width="10%"><input name="openo" type="button" style="width:30px" value="开" onclick="openOrg(this,'<bean:write name="stOrgSpreadVo" property="orgcode" />',
									'<bean:write name="stOrgSpreadVo" property="id" />','<bean:write name="stOrgSpreadVo" property="orgname" />')" /></td>
									
								<td><input name="closeo" type="button" style="width:30px" disabled value="关 " onclick="closeOrg(this,'<bean:write name="stOrgSpreadVo" property="orgcode" />',
									'<bean:write name="stOrgSpreadVo" property="id" />','<bean:write name="stOrgSpreadVo" property="orgname" />')" /></td>
								</logic:equal>
								<!-- 判断机构是否开启 -->
								<logic:equal value="1" name="stOrgSpreadVo" property="isopen">
									<td width="10%"><input name="openo" style="width:30px" type="button" disabled value="开" onclick="openOrg(this,'<bean:write name="stOrgSpreadVo" property="orgcode" />',
									'<bean:write name="stOrgSpreadVo" property="id" />','<bean:write name="stOrgSpreadVo" property="orgname" />')" /></td>
									
									<td><input name="closeo" type="button"  style="width:30px"  value="关 " onclick="closeOrg(this,'<bean:write name="stOrgSpreadVo" property="orgcode" />',
									'<bean:write name="stOrgSpreadVo" property="id" />','<bean:write name="stOrgSpreadVo" property="orgname" />')" /></td>
								</logic:equal>
							</td>
						</tr>
...
function query(){
	...
	with(document.forms[0]){
		operAtt.value="queryCorpOrgByOfficeId";
		submit();
	}
}
/**
